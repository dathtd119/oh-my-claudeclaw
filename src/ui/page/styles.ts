export const pageStyles = String.raw`    :root {
    ...
    * { box-sizing: border-box; }
    ...
    .main-tab { background: none; border: none; color: rgba(255,255,255,0.4); padding: 0.3rem 0.7rem; border-radius: 6px; cursor: pointer; font-family: 'Space Grotesk', sans-serif; font-size: 0.85rem; font-weight: 500; transition: all 0.2s; }
    .main-tab:hover { color: rgba(255,255,255,0.7); }
    .main-tab.active { background: rgba(255,255,255,0.1); color: #fff; }
    .main-tab-panel { }
    .main-tab-hidden { display: none; }
    .task-add-row { display: flex; gap: 0.5rem; margin-bottom: 0.6rem; }
    .task-add-input { flex: 1; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); color: #fff; padding: 0.45rem 0.7rem; border-radius: 6px; font-family: 'Space Grotesk', sans-serif; font-size: 0.82rem; outline: none; }
    .task-add-input::placeholder { color: rgba(255,255,255,0.3); }
    .task-add-input:focus { border-color: rgba(255,255,255,0.25); }
    .task-add-btn { background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12); color: #fff; padding: 0.45rem 0.8rem; border-radius: 6px; cursor: pointer; font-family: 'Space Grotesk', sans-serif; font-size: 0.82rem; transition: all 0.2s; }
    .task-add-btn:hover { background: rgba(255,255,255,0.15); }
    .task-status-badge { display: inline-block; font-size: 0.65rem; padding: 0.1rem 0.35rem; border-radius: 4px; background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.5); margin-right: 0.4rem; }
